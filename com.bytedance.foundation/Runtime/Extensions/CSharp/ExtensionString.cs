...
namespace ByteDance.Foundation
{
    public static class ExtensionString
    {
        ...
        */
        ...
        {
            return (s.IsNOTNullOrEmpty()) ? s.ToCharArray().ToList() : null;
        }
        ...
        public static string CreateRandomPassword(this string sVal, int PasswordLength, bool allowMixedCase,
            bool allowNumbers, bool allowSpecialCharacters)
        {
        ...
        public static string CreateRandomPassword(this string sVal, int PasswordLength,
            bool ignoreProgrammingCharacters)
        {
            return CreateRandomPassword(sVal, PasswordLength, true, true, true, true, true, true,
                ignoreProgrammingCharacters);
        }
        ...
        /// <param name="ignoreProgrammingCharacters">Avoid punctuation used in programming <![CDATA[ ($, ', ", &, [space], ,, ?, @, #, <, >, (, ), {, }, [, ], /, \) ]]> .</param>
        public static string CreateRandomPassword(this string sVal, int PasswordLength, bool allowMixedCase,
            bool allowNumbers, bool allowSpecialCharacters, bool ignoreProgrammingCharacters)
        {
            return CreateRandomPassword(sVal, PasswordLength, true, true, true, false, false, false,
                ignoreProgrammingCharacters);
        }
        ...
        /// <param name="ignoreProgrammingCharacters">Avoid punctuation used in programming <![CDATA[ ($, ', ", &, [space], ,, ?, @, #, <, >, (, ), {, }, [, ], /, \) ]]> .</param>
        public static string CreateRandomPassword(this string sVal, int PasswordLength, bool allowMixedCase,
            bool allowNumbers, bool allowSpecialCharacters, bool mixedCaseRequired, bool numberRequired,
            bool specialRequired, bool ignoreProgrammingCharacters)
        {
            #region Validation

            if ((!allowMixedCase) && (mixedCaseRequired))
                throw new ArgumentException("mixedCaseRequired cannot be true if allowMixedCase is false",
                    "allowMixedCase");
            ...
            if ((!allowSpecialCharacters) && (specialRequired))
                throw new ArgumentException("specialRequired cannot be true if allowSpecialCharacters is false",
        ...
        private static char GetSpecialCode(bool ignoreProgrammingCharacters)
        {
            ...
            do
            {
                ...
                // skip numbers (ASCII 48 - 57)
                     ...
                     (ignoreProgrammingCharacters && specialCode.IsNotIn(37, 42, 43, 45, 61))
            ); // only allow %, *, +, -, =   if ignore programming
