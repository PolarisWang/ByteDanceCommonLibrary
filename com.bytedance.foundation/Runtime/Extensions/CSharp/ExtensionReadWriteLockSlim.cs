...
namespace ByteDance.Foundation
{
    ...
    /// </summary>
    public static class ExtensionReadWriteLockSlim
    {
        ...
        public static void PerformUsingUpgradeableReadLock(this ReaderWriterLockSlim readerWriterLockSlim,
            Action action)
        {
            try
            {
        ...
        public static T PerformUsingUpgradeableReadLock<T>(this ReaderWriterLockSlim readerWriterLockSlim,
            Func<T> action)
        {
            try
            {
