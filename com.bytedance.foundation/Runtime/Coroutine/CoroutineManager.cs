...
namespace ByteDance.Foundation.Coroutine
{
    public class CoroutineManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// You can use "yield return CoroutineManager.WaitForOneFrame;" inside a coroutine function to go to the next frame. 
        ...
        private static readonly Dictionary<byte, CoroutineManager> ActiveInstances = new Dictionary<byte, CoroutineManager>();
        ...
        public static CoroutineManager Instance
        {
            get
            {
                ...
                {
                    GameObject parent = GameObject.Find(FoundationConst.NameGlobals);
                    GameObject instanceHome = GameObject.Find(FoundationConst.NameCoroutineManager);

                    if (parent == null)
                    {
                        parent = new GameObject() {name = FoundationConst.NameGlobals };
                    }


                    if (instanceHome == null)
                    {
                        instanceHome = new GameObject { name = FoundationConst.NameCoroutineManager };
                        instanceHome.transform.parent = parent.transform;
                        _instance = instanceHome.AddComponent<CoroutineManager>();
                    }
                    else
                    {
                        _instance = instanceHome.GetComponent<CoroutineManager>() ?? instanceHome.AddComponent<CoroutineManager>();
                    }
                }
        ...
        /// <summary>
        /// Run a new coroutine on this CoroutineManager instance in the Update segment.
        /// </summary>
        /// <param name="coroutine">The new coroutine's handle.</param>
        /// <returns>The coroutine's handle, which can be used for Wait and Kill operations.</returns>
        ...
        /// <summary>
        /// Run a new coroutine on this CoroutineManager instance.
        /// </summary>
        /// <param name="coroutine">The new coroutine's handle.</param>
        /// <param name="timing">The segment that the coroutine should run in.</param>
        /// <returns>The coroutine's handle, which can be used for Wait and Kill operations.</returns>
        ...
        /// <summary>
        /// Kills the instance of the coroutine handle on this CoroutineManager instance if it exists.
        /// </summary>
        /// <param name="handle">The handle of the coroutine to kill.</param>
        /// <returns>The number of coroutines that were found and killed (0 or 1).</returns>
        ...
        public static CoroutineManager GetInstance(byte ID)
        {
        ...
        /// <summary>
        /// Use "yield return CoroutineManager.WaitForSeconds(time);" to wait for the specified number of seconds.
        /// </summary>
        ...
        /// <summary>
        /// Use the command "yield return CoroutineManager.WaitUntilDone(otherCoroutine);" to pause the current 
        ...
        /// <summary>
        /// Use the command "yield return CoroutineManager.WaitUntilDone(otherCoroutine, false);" to pause the current 
        ...
        {
            CoroutineManager inst = GetInstance(otherCoroutine.Key);
        ...
        /// <summary>
        /// Use the command "yield return CoroutineManager.WaitUntilDone(wwwObject);" to pause the current 
        ...
        /// <summary>
        /// Use the command "yield return CoroutineManager.WaitUntilDone(operation);" to pause the current 
        ...
        //public new UnityEngine.Coroutine StartCoroutine(System.Collections.IEnumerator routine) { return null; }

        [System.Obsolete("Unity coroutine function, use RunCoroutine instead.", true)]
        public new UnityEngine.Coroutine StartCoroutine(string methodName, object value) { return null; }

        [System.Obsolete("Unity coroutine function, use RunCoroutine instead.", true)]
        public new UnityEngine.Coroutine StartCoroutine(string methodName) { return null; }

        [System.Obsolete("Unity coroutine function, use RunCoroutine instead.", true)]
        public new UnityEngine.Coroutine StartCoroutine_Auto(System.Collections.IEnumerator routine) { return null; }
    ...
    {
        public static CoroutineHandle Empty = new CoroutineHandle();
        ...
        public CoroutineHandle(int coroutineId, bool isFromCoroutineId)
        {
            _id = coroutineId;
        }

        public int ToCoutineId()
        {
            return _id;
        }
    ...
    public static class DeferExtensionMethods
    {
        /// <summary>
        ...
        {
            while (Foundation.Coroutine.CoroutineManager.MainThread != System.Threading.Thread.CurrentThread || (gameObject && gameObject.activeInHierarchy && coroutine.MoveNext()))
        ...
        {
            while (Foundation.Coroutine.CoroutineManager.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy &&
