...
namespace ByteDance.Foundation
{
    public partial class MyLogger
    {
        ...
        [Conditional("DEBUG")]
        public static void DebugSegment(Vector3 start, Vector3 end, Color color, float duration = 0, bool depthTest = true)
        {
        ...
        [Conditional("DEBUG")]
        public static void DebugArrow(Vector3 target, Color color, float duration = 0, bool depthTest = true)
        {
            var position = target + Vector3.up;
